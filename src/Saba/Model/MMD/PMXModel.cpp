...
decltype(brx_motion_create_skeleton) *const motion_create_skeleton = reinterpret_cast<decltype(brx_motion_create_skeleton) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_create_skeleton"));
decltype(brx_motion_destroy_skeleton) *const motion_destroy_skeleton = reinterpret_cast<decltype(brx_motion_destroy_skeleton) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_destroy_skeleton"));
decltype(brx_motion_create_skeleton_instance) *const motion_create_skeleton_instance = reinterpret_cast<decltype(brx_motion_create_skeleton_instance) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_create_skeleton_instance"));
decltype(brx_motion_destroy_skeleton_instance) *const motion_destroy_skeleton_instance = reinterpret_cast<decltype(brx_motion_destroy_skeleton_instance) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_destroy_skeleton_instance"));

decltype(brx_motion_create_video_capture) *const motion_create_video_capture = reinterpret_cast<decltype(brx_motion_create_video_capture) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_create_video_capture"));
decltype(brx_motion_destroy_video_capture) *const motion_destroy_video_capture = reinterpret_cast<decltype(brx_motion_destroy_video_capture) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_destroy_video_capture"));
decltype(brx_motion_create_video_detector) *const motion_create_video_detector = reinterpret_cast<decltype(brx_motion_create_video_detector) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_create_video_detector"));
decltype(brx_motion_destroy_video_detector) *const motion_destroy_video_detector = reinterpret_cast<decltype(brx_motion_destroy_video_detector) *>(_internal_dynamic_link_symbol(motion_dynamic_link_handle, "brx_motion_destroy_video_detector"));
...
namespace saba
{
	...
	bool PMXModel::Load(const std::string &filepath, const std::string &mmdDataDir)
	{
		...
		asset_import_destroy_scene(scene);
		...
		this->m_motion_video_capture = motion_create_video_capture("camera://0");

		assert(NULL == this->m_motion_video_detector);
		this->m_motion_video_detector = motion_create_video_detector(1U, 1U, true);
	...
	{
		assert(NULL != this->m_skeleton_instance);
		motion_destroy_skeleton_instance(this->m_skeleton_instance);

		assert(NULL != this->m_skeleton);
		motion_destroy_skeleton(this->m_skeleton);
